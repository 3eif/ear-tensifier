...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if(!args[0]){
            ...
            let msg = await message.channel.send(`${client.emojiList.loading} Turning on **bassboost**. This may take a few seconds...`)
        ...
        if(args[0].toLowerCase() == "reset" || args[0].toLowerCase() == "off") {
            ...
            let msg = await message.channel.send(`${client.emojiList.loading} Turning off **bassboost**. This may take a few seconds...`)
            const embed = new Discord.MessageEmbed()
            .setAuthor(message.guild.name, message.guild.iconURL())
