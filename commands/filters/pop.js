...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (args[0] && (args[0].toLowerCase() == "reset" || args[0].toLowerCase() == "off")) {
            ...
            let msg = await message.channel.send(`${client.emojiList.loading} Turning off **pop**. This may take a few seconds...`)
        ...
        let msg = await message.channel.send(`${client.emojiList.loading} Turning on **pop**. This may take a few seconds...`)
        const embed = new Discord.MessageEmbed()
            .setAuthor(message.guild.name, message.guild.iconURL())
