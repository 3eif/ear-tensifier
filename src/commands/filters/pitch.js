...
module.exports = class Pitch extends Command {
	...
	async run(client, message, args) {
		...
		if (args[0] < 0.1) return message.channel.send('Pitch must be greater than 0.1.');
		if (args[0] > 10) return message.channel.send('Pitch must be less than or equal to 10.');
